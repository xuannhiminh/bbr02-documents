...
import com.ezteam.baseproject.databinding.BaseDialogRateAppBinding
...
open class DialogRating(
...
) : BaseDialog<BaseDialogRateAppBinding, DialogRating.ExtendBuilder>(extendBuilder, context) {
    companion object {
    ...
    override val viewBinding: BaseDialogRateAppBinding
        get() = BaseDialogRateAppBinding.inflate(
                LayoutInflater.from(
                        context
                )
        )
