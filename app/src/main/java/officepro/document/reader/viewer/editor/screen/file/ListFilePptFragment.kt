...
open class ListFilePptFragment(private val filesLiveData: LiveData<List<FileModel>>) : PdfBaseFragment<FragmentListFileTypeBinding>(),
    IAdsControl {
    ...
    override fun initData() {
        ...
        viewModel.loadTotalFiles("PPT").observe(this) { totalNumber ->
