...
open class ListFileAllFragment(private val filesLiveData: LiveData<List<FileModel>>) : PdfBaseFragment<FragmentListFileTypeBinding>(),
    IAdsControl {
    ...
    override fun initData() {
        ...
        viewModel.loadTotalFiles("ALL").observe(this) { totalNumber ->
