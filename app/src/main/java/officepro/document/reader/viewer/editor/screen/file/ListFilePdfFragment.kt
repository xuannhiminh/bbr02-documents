...
open class ListFilePdfFragment(private val filesLiveData: LiveData<List<FileModel>>) : PdfBaseFragment<FragmentListFileTypeBinding>(),
    IAdsControl {
    ...
    override fun initData() {
        ...
        viewModel.loadTotalFiles("PDF").observe(this) { totalNumber ->
