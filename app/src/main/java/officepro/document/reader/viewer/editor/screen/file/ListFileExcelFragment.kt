...
import office.pdf.document.reader.viewer.editor.databinding.FragmentListFileTypeBinding
...
open class ListFileExcelFragment(private val filesLiveData: LiveData<List<FileModel>>) : PdfBaseFragment<FragmentListFileTypeBinding>(),
    IAdsControl {
    ...
    override fun initData() {
        ...
        viewModel.loadTotalFiles("EXCEL").observe(this) { totalNumber ->
