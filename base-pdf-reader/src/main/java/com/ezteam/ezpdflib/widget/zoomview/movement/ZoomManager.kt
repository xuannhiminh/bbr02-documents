package com.ezteam.ezpdflib.widget.zoomview.movement

import com.ezteam.ezpdflib.widget.zoomview.OverZoomRangeProvider
import com.ezteam.ezpdflib.widget.zoomview.ZoomApi
import com.ezteam.ezpdflib.widget.zoomview.ZoomEngine
...
//
//        // Log khi zoom bị giới hạn
//        if (clampedValue != value) {
//            if (value < minZoom) {
//                LOG.w("Zoom clamped to minimum: $value -> $clampedValue (min: $minZoom)")
//            } else if (value > maxZoom) {
//                LOG.w("Zoom clamped to maximum: $value -> $clampedValue (max: $maxZoom)")
//            }
//        }
//
//        return clampedValue
